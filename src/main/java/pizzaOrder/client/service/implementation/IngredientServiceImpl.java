...
//		List<Ingredients> ingredientsHal = new ArrayList<Ingredients>(halTemplate.getForObject("http://localhost:8080/ingredients", PagedResources.class).getContent());
		List<Ingredients> ingredientsHal = new ArrayList<Ingredients>(halTemplate.getForObject("https://limitless-eyrie-45489.herokuapp.com/ingredients", PagedResources.class).getContent());
